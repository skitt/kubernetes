...
# test/utils/oidc/testserver.go needs the mocks to build; mockery processes full packages,
# and fails if testserver.go can't be built. Rename it out of the way for mock generation.
kube::util::trap_add "mv test/utils/oidc/testserver.go.disabled test/utils/oidc/testserver.go" EXIT
mv test/utils/oidc/testserver.go test/utils/oidc/testserver.go.disabled
