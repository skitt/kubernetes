...
type statefulSets struct {
	*gentype2.ClientWithListAndApply[*appsv1beta2.StatefulSet, *appsv1beta2.StatefulSetList, *applyconfigurationsappsv1beta2.StatefulSetApplyConfiguration, appsv1beta2.StatefulSet, appsv1beta2.StatefulSetList]
}

// newStatefulSets returns a StatefulSets
func newStatefulSets(c *AppsV1beta2Client, namespace string) *statefulSets {
	return &statefulSets{
		gentype2.NewClientWithListAndApply[*appsv1beta2.StatefulSet, *appsv1beta2.StatefulSetList, *applyconfigurationsappsv1beta2.StatefulSetApplyConfiguration, appsv1beta2.StatefulSet, appsv1beta2.StatefulSetList](
			"statefulsets",
			c.RESTClient(),
...
func (c *statefulSets) GetScale(ctx context.Context, statefulSetName string, options v1.GetOptions) (*appsv1beta2.Scale, error) {
	return gentype2.GetSubresource[*appsv1beta2.Scale](ctx, c.UntypedClient, statefulSetName, options, "scale")
}
...
func (c *statefulSets) UpdateScale(ctx context.Context, statefulSetName string, scale *appsv1beta2.Scale, opts v1.UpdateOptions) (*appsv1beta2.Scale, error) {
	return gentype2.UpdateSubresource[*appsv1beta2.Scale](ctx, c.UntypedClient, statefulSetName, scale, opts, "scale")
}

// ApplyScale takes top resource name and the apply declarative configuration for scale,
// applies it and returns the applied scale, and an error, if there is any.
func (c *statefulSets) ApplyScale(ctx context.Context, statefulSetName string, scale *applyconfigurationsappsv1beta2.ScaleApplyConfiguration, opts v1.ApplyOptions) (*appsv1beta2.Scale, error) {
	return gentype2.ApplySubresource[*appsv1beta2.Scale](ctx, c.UntypedClient, statefulSetName, scale, opts, "scale")
}
