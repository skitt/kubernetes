...
type replicaSets struct {
	*gentype2.ClientWithListAndApply[*appsv1.ReplicaSet, *appsv1.ReplicaSetList, *applyconfigurationsappsv1.ReplicaSetApplyConfiguration, appsv1.ReplicaSet, appsv1.ReplicaSetList]
}

// newReplicaSets returns a ReplicaSets
func newReplicaSets(c *AppsV1Client, namespace string) *replicaSets {
	return &replicaSets{
		gentype2.NewClientWithListAndApply[*appsv1.ReplicaSet, *appsv1.ReplicaSetList, *applyconfigurationsappsv1.ReplicaSetApplyConfiguration, appsv1.ReplicaSet, appsv1.ReplicaSetList](
			"replicasets",
			c.RESTClient(),
...
func (c *replicaSets) GetScale(ctx context.Context, replicaSetName string, options metav1.GetOptions) (*autoscalingv1.Scale, error) {
	return gentype2.GetSubresource[*autoscalingv1.Scale](ctx, c.UntypedClient, replicaSetName, options, "scale")
}
...
func (c *replicaSets) UpdateScale(ctx context.Context, replicaSetName string, scale *autoscalingv1.Scale, opts metav1.UpdateOptions) (*autoscalingv1.Scale, error) {
	return gentype2.UpdateSubresource[*autoscalingv1.Scale](ctx, c.UntypedClient, replicaSetName, scale, opts, "scale")
}

// ApplyScale takes top resource name and the apply declarative configuration for scale,
// applies it and returns the applied scale, and an error, if there is any.
func (c *replicaSets) ApplyScale(ctx context.Context, replicaSetName string, scale *applyconfigurationsautoscalingv1.ScaleApplyConfiguration, opts metav1.ApplyOptions) (*autoscalingv1.Scale, error) {
	return gentype2.ApplySubresource[*autoscalingv1.Scale](ctx, c.UntypedClient, replicaSetName, scale, opts, "scale")
}
