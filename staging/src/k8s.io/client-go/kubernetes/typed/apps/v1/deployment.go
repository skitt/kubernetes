...
type deployments struct {
	*gentype2.ClientWithListAndApply[*appsv1.Deployment, *appsv1.DeploymentList, *applyconfigurationsappsv1.DeploymentApplyConfiguration, appsv1.Deployment, appsv1.DeploymentList]
}

// newDeployments returns a Deployments
func newDeployments(c *AppsV1Client, namespace string) *deployments {
	return &deployments{
		gentype2.NewClientWithListAndApply[*appsv1.Deployment, *appsv1.DeploymentList, *applyconfigurationsappsv1.DeploymentApplyConfiguration, appsv1.Deployment, appsv1.DeploymentList](
			"deployments",
			c.RESTClient(),
...
func (c *deployments) GetScale(ctx context.Context, deploymentName string, options metav1.GetOptions) (*autoscalingv1.Scale, error) {
	return gentype2.GetSubresource[*autoscalingv1.Scale](ctx, c.UntypedClient, deploymentName, options, "scale")
}
...
func (c *deployments) UpdateScale(ctx context.Context, deploymentName string, scale *autoscalingv1.Scale, opts metav1.UpdateOptions) (*autoscalingv1.Scale, error) {
	return gentype2.UpdateSubresource[*autoscalingv1.Scale](ctx, c.UntypedClient, deploymentName, scale, opts, "scale")
}

// ApplyScale takes top resource name and the apply declarative configuration for scale,
// applies it and returns the applied scale, and an error, if there is any.
func (c *deployments) ApplyScale(ctx context.Context, deploymentName string, scale *applyconfigurationsautoscalingv1.ScaleApplyConfiguration, opts metav1.ApplyOptions) (*autoscalingv1.Scale, error) {
	return gentype2.ApplySubresource[*autoscalingv1.Scale](ctx, c.UntypedClient, deploymentName, scale, opts, "scale")
}
