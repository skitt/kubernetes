...
type statefulSets struct {
	*gentype2.ClientWithListAndApply[*appsv1.StatefulSet, *appsv1.StatefulSetList, *applyconfigurationsappsv1.StatefulSetApplyConfiguration, appsv1.StatefulSet, appsv1.StatefulSetList]
}

// newStatefulSets returns a StatefulSets
func newStatefulSets(c *AppsV1Client, namespace string) *statefulSets {
	return &statefulSets{
		gentype2.NewClientWithListAndApply[*appsv1.StatefulSet, *appsv1.StatefulSetList, *applyconfigurationsappsv1.StatefulSetApplyConfiguration, appsv1.StatefulSet, appsv1.StatefulSetList](
			"statefulsets",
			c.RESTClient(),
...
func (c *statefulSets) GetScale(ctx context.Context, statefulSetName string, options metav1.GetOptions) (*autoscalingv1.Scale, error) {
	return gentype2.GetSubresource[*autoscalingv1.Scale](ctx, c.UntypedClient, statefulSetName, options, "scale")
}
...
func (c *statefulSets) UpdateScale(ctx context.Context, statefulSetName string, scale *autoscalingv1.Scale, opts metav1.UpdateOptions) (*autoscalingv1.Scale, error) {
	return gentype2.UpdateSubresource[*autoscalingv1.Scale](ctx, c.UntypedClient, statefulSetName, scale, opts, "scale")
}

// ApplyScale takes top resource name and the apply declarative configuration for scale,
// applies it and returns the applied scale, and an error, if there is any.
func (c *statefulSets) ApplyScale(ctx context.Context, statefulSetName string, scale *applyconfigurationsautoscalingv1.ScaleApplyConfiguration, opts metav1.ApplyOptions) (*autoscalingv1.Scale, error) {
	return gentype2.ApplySubresource[*autoscalingv1.Scale](ctx, c.UntypedClient, statefulSetName, scale, opts, "scale")
}
