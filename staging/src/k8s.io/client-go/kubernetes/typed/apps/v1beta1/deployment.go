...
type deployments struct {
	*gentype2.ClientWithListAndApply[*appsv1beta1.Deployment, *appsv1beta1.DeploymentList, *applyconfigurationsappsv1beta1.DeploymentApplyConfiguration, appsv1beta1.Deployment, appsv1beta1.DeploymentList]
}

// newDeployments returns a Deployments
func newDeployments(c *AppsV1beta1Client, namespace string) *deployments {
	return &deployments{
		gentype2.NewClientWithListAndApply[*appsv1beta1.Deployment, *appsv1beta1.DeploymentList, *applyconfigurationsappsv1beta1.DeploymentApplyConfiguration, appsv1beta1.Deployment, appsv1beta1.DeploymentList](
			"deployments",
			c.RESTClient(),
			...
			gentype2.PrefersProtobuf[*appsv1beta1.Deployment](),
		),
	}
}
