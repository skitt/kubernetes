...
type mutatingWebhookConfigurations struct {
	*gentype2.ClientWithListAndApply[*admissionregistrationv1beta1.MutatingWebhookConfiguration, *admissionregistrationv1beta1.MutatingWebhookConfigurationList, *applyconfigurationsadmissionregistrationv1beta1.MutatingWebhookConfigurationApplyConfiguration, admissionregistrationv1beta1.MutatingWebhookConfiguration, admissionregistrationv1beta1.MutatingWebhookConfigurationList]
}
...
func newMutatingWebhookConfigurations(c *AdmissionregistrationV1beta1Client) *mutatingWebhookConfigurations {
	return &mutatingWebhookConfigurations{
		gentype2.NewClientWithListAndApply[*admissionregistrationv1beta1.MutatingWebhookConfiguration, *admissionregistrationv1beta1.MutatingWebhookConfigurationList, *applyconfigurationsadmissionregistrationv1beta1.MutatingWebhookConfigurationApplyConfiguration, admissionregistrationv1beta1.MutatingWebhookConfiguration, admissionregistrationv1beta1.MutatingWebhookConfigurationList](
