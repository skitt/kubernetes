...
type validatingWebhookConfigurations struct {
	*gentype2.ClientWithListAndApply[*admissionregistrationv1beta1.ValidatingWebhookConfiguration, *admissionregistrationv1beta1.ValidatingWebhookConfigurationList, *applyconfigurationsadmissionregistrationv1beta1.ValidatingWebhookConfigurationApplyConfiguration, admissionregistrationv1beta1.ValidatingWebhookConfiguration, admissionregistrationv1beta1.ValidatingWebhookConfigurationList]
}
...
func newValidatingWebhookConfigurations(c *AdmissionregistrationV1beta1Client) *validatingWebhookConfigurations {
	return &validatingWebhookConfigurations{
		gentype2.NewClientWithListAndApply[*admissionregistrationv1beta1.ValidatingWebhookConfiguration, *admissionregistrationv1beta1.ValidatingWebhookConfigurationList, *applyconfigurationsadmissionregistrationv1beta1.ValidatingWebhookConfigurationApplyConfiguration, admissionregistrationv1beta1.ValidatingWebhookConfiguration, admissionregistrationv1beta1.ValidatingWebhookConfigurationList](
			...
			gentype2.PrefersProtobuf[*admissionregistrationv1beta1.ValidatingWebhookConfiguration](),
		),
	}
}
