...
type validatingAdmissionPolicies struct {
	*gentype2.ClientWithListAndApply[*admissionregistrationv1alpha1.ValidatingAdmissionPolicy, *admissionregistrationv1alpha1.ValidatingAdmissionPolicyList, *applyconfigurationsadmissionregistrationv1alpha1.ValidatingAdmissionPolicyApplyConfiguration, admissionregistrationv1alpha1.ValidatingAdmissionPolicy, admissionregistrationv1alpha1.ValidatingAdmissionPolicyList]
}
...
func newValidatingAdmissionPolicies(c *AdmissionregistrationV1alpha1Client) *validatingAdmissionPolicies {
	return &validatingAdmissionPolicies{
		gentype2.NewClientWithListAndApply[*admissionregistrationv1alpha1.ValidatingAdmissionPolicy, *admissionregistrationv1alpha1.ValidatingAdmissionPolicyList, *applyconfigurationsadmissionregistrationv1alpha1.ValidatingAdmissionPolicyApplyConfiguration, admissionregistrationv1alpha1.ValidatingAdmissionPolicy, admissionregistrationv1alpha1.ValidatingAdmissionPolicyList](
