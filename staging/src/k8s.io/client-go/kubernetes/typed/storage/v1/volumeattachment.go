...
type volumeAttachments struct {
	*gentype2.ClientWithListAndApply[*storagev1.VolumeAttachment, *storagev1.VolumeAttachmentList, *applyconfigurationsstoragev1.VolumeAttachmentApplyConfiguration, storagev1.VolumeAttachment, storagev1.VolumeAttachmentList]
}

// newVolumeAttachments returns a VolumeAttachments
func newVolumeAttachments(c *StorageV1Client) *volumeAttachments {
	return &volumeAttachments{
		gentype2.NewClientWithListAndApply[*storagev1.VolumeAttachment, *storagev1.VolumeAttachmentList, *applyconfigurationsstoragev1.VolumeAttachmentApplyConfiguration, storagev1.VolumeAttachment, storagev1.VolumeAttachmentList](
			"volumeattachments",
			c.RESTClient(),
			scheme.ParameterCodec,
			"",
			gentype2.PrefersProtobuf[*storagev1.VolumeAttachment](),
		),
	}
}
