...
type ingresses struct {
	*gentype2.ClientWithListAndApply[*networkingv1.Ingress, *networkingv1.IngressList, *applyconfigurationsnetworkingv1.IngressApplyConfiguration, networkingv1.Ingress, networkingv1.IngressList]
}

// newIngresses returns a Ingresses
func newIngresses(c *NetworkingV1Client, namespace string) *ingresses {
	return &ingresses{
		gentype2.NewClientWithListAndApply[*networkingv1.Ingress, *networkingv1.IngressList, *applyconfigurationsnetworkingv1.IngressApplyConfiguration, networkingv1.Ingress, networkingv1.IngressList](
			"ingresses",
			c.RESTClient(),
