...
type selfSubjectAccessReviews struct {
	*gentype2.Client[*authorizationv1beta1.SelfSubjectAccessReview, authorizationv1beta1.SelfSubjectAccessReview]
}
...
func newSelfSubjectAccessReviews(c *AuthorizationV1beta1Client) *selfSubjectAccessReviews {
	return &selfSubjectAccessReviews{
		gentype2.NewClient[*authorizationv1beta1.SelfSubjectAccessReview, authorizationv1beta1.SelfSubjectAccessReview](
			"selfsubjectaccessreviews",
			c.RESTClient(),
			scheme.ParameterCodec,
			"",
			gentype2.PrefersProtobuf[*authorizationv1beta1.SelfSubjectAccessReview](),
		),
	}
}
