...
type events struct {
	*gentype2.ClientWithListAndApply[*eventsv1beta1.Event, *eventsv1beta1.EventList, *applyconfigurationseventsv1beta1.EventApplyConfiguration, eventsv1beta1.Event, eventsv1beta1.EventList]
}

// newEvents returns a Events
func newEvents(c *EventsV1beta1Client, namespace string) *events {
	return &events{
		gentype2.NewClientWithListAndApply[*eventsv1beta1.Event, *eventsv1beta1.EventList, *applyconfigurationseventsv1beta1.EventApplyConfiguration, eventsv1beta1.Event, eventsv1beta1.EventList](
			"events",
			c.RESTClient(),
