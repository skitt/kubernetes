...
type events struct {
	*generic.TypeClientWithListAndApply[*v1.Event, *v1.EventList, *eventsv1.EventApplyConfiguration]
}

// newEvents returns a Events
func newEvents(c *EventsV1Client, namespace string) *events {
	return &events{
		generic.NewNamespacedWithListAndApply[*v1.Event, *v1.EventList, *eventsv1.EventApplyConfiguration](
			"events",
			c.RESTClient(),
