...
type replicaSets struct {
	*gentype2.ClientWithListAndApply[*extensionsv1beta1.ReplicaSet, *extensionsv1beta1.ReplicaSetList, *applyconfigurationsextensionsv1beta1.ReplicaSetApplyConfiguration, extensionsv1beta1.ReplicaSet, extensionsv1beta1.ReplicaSetList]
}

// newReplicaSets returns a ReplicaSets
func newReplicaSets(c *ExtensionsV1beta1Client, namespace string) *replicaSets {
	return &replicaSets{
		gentype2.NewClientWithListAndApply[*extensionsv1beta1.ReplicaSet, *extensionsv1beta1.ReplicaSetList, *applyconfigurationsextensionsv1beta1.ReplicaSetApplyConfiguration, extensionsv1beta1.ReplicaSet, extensionsv1beta1.ReplicaSetList](
			"replicasets",
			c.RESTClient(),
...
func (c *replicaSets) GetScale(ctx context.Context, replicaSetName string, options v1.GetOptions) (*extensionsv1beta1.Scale, error) {
	return gentype2.GetSubresource[*extensionsv1beta1.Scale](ctx, c.UntypedClient, replicaSetName, options, "scale")
}
...
func (c *replicaSets) UpdateScale(ctx context.Context, replicaSetName string, scale *extensionsv1beta1.Scale, opts v1.UpdateOptions) (*extensionsv1beta1.Scale, error) {
	return gentype2.UpdateSubresource[*extensionsv1beta1.Scale](ctx, c.UntypedClient, replicaSetName, scale, opts, "scale")
}

// ApplyScale takes top resource name and the apply declarative configuration for scale,
// applies it and returns the applied scale, and an error, if there is any.
func (c *replicaSets) ApplyScale(ctx context.Context, replicaSetName string, scale *applyconfigurationsextensionsv1beta1.ScaleApplyConfiguration, opts v1.ApplyOptions) (*extensionsv1beta1.Scale, error) {
	return gentype2.ApplySubresource[*extensionsv1beta1.Scale](ctx, c.UntypedClient, replicaSetName, scale, opts, "scale")
}
