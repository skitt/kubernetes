...
type deployments struct {
	*gentype2.ClientWithListAndApply[*extensionsv1beta1.Deployment, *extensionsv1beta1.DeploymentList, *applyconfigurationsextensionsv1beta1.DeploymentApplyConfiguration, extensionsv1beta1.Deployment, extensionsv1beta1.DeploymentList]
}

// newDeployments returns a Deployments
func newDeployments(c *ExtensionsV1beta1Client, namespace string) *deployments {
	return &deployments{
		gentype2.NewClientWithListAndApply[*extensionsv1beta1.Deployment, *extensionsv1beta1.DeploymentList, *applyconfigurationsextensionsv1beta1.DeploymentApplyConfiguration, extensionsv1beta1.Deployment, extensionsv1beta1.DeploymentList](
			"deployments",
			c.RESTClient(),
...
func (c *deployments) GetScale(ctx context.Context, deploymentName string, options v1.GetOptions) (*extensionsv1beta1.Scale, error) {
	return gentype2.GetSubresource[*extensionsv1beta1.Scale](ctx, c.UntypedClient, deploymentName, options, "scale")
}
...
func (c *deployments) UpdateScale(ctx context.Context, deploymentName string, scale *extensionsv1beta1.Scale, opts v1.UpdateOptions) (*extensionsv1beta1.Scale, error) {
	return gentype2.UpdateSubresource[*extensionsv1beta1.Scale](ctx, c.UntypedClient, deploymentName, scale, opts, "scale")
}

// ApplyScale takes top resource name and the apply declarative configuration for scale,
// applies it and returns the applied scale, and an error, if there is any.
func (c *deployments) ApplyScale(ctx context.Context, deploymentName string, scale *applyconfigurationsextensionsv1beta1.ScaleApplyConfiguration, opts v1.ApplyOptions) (*extensionsv1beta1.Scale, error) {
	return gentype2.ApplySubresource[*extensionsv1beta1.Scale](ctx, c.UntypedClient, deploymentName, scale, opts, "scale")
}
