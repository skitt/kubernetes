...
type fakeClusterTestTypes struct {
	*gentype2.FakeClientWithListAndApply[*v1.ClusterTestType, *v1.ClusterTestTypeList, *apiv1.ClusterTestTypeApplyConfiguration, v1.ClusterTestType, v1.ClusterTestTypeList]
	Fake *FakeExampleV1
}

func newFakeClusterTestTypes(fake *FakeExampleV1) typedapiv1.ClusterTestTypeInterface {
	return &fakeClusterTestTypes{
		gentype2.NewFakeClientWithListAndApply[*v1.ClusterTestType, *v1.ClusterTestTypeList, *apiv1.ClusterTestTypeApplyConfiguration, v1.ClusterTestType, v1.ClusterTestTypeList](
			fake.Fake,
			"",
