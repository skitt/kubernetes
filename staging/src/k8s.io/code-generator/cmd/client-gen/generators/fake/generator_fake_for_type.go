...
func (g *genFakeForType) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"FakeClient":                                c.Universe.Type(types.Name{Package: "k8s.io/client-go/gentype2", Name: "FakeClient"}),
		"NewFakeClient":                             c.Universe.Function(types.Name{Package: "k8s.io/client-go/gentype2", Name: "NewFakeClient"}),
		"FakeClientWithApply":                       c.Universe.Type(types.Name{Package: "k8s.io/client-go/gentype2", Name: "FakeClientWithApply"}),
		"NewFakeClientWithApply":                    c.Universe.Function(types.Name{Package: "k8s.io/client-go/gentype2", Name: "NewFakeClientWithApply"}),
		"FakeClientWithList":                        c.Universe.Type(types.Name{Package: "k8s.io/client-go/gentype2", Name: "FakeClientWithList"}),
		"NewFakeClientWithList":                     c.Universe.Function(types.Name{Package: "k8s.io/client-go/gentype2", Name: "NewFakeClientWithList"}),
		"FakeClientWithListAndApply":                c.Universe.Type(types.Name{Package: "k8s.io/client-go/gentype2", Name: "FakeClientWithListAndApply"}),
		"NewFakeClientWithListAndApply":             c.Universe.Function(types.Name{Package: "k8s.io/client-go/gentype2", Name: "NewFakeClientWithListAndApply"}),
	}
