...
type podMetricses struct {
	*gentype2.ClientWithList[*metricsv1beta1.PodMetrics, *metricsv1beta1.PodMetricsList, metricsv1beta1.PodMetrics, metricsv1beta1.PodMetricsList]
}

// newPodMetricses returns a PodMetricses
func newPodMetricses(c *MetricsV1beta1Client, namespace string) *podMetricses {
	return &podMetricses{
		gentype2.NewClientWithList[*metricsv1beta1.PodMetrics, *metricsv1beta1.PodMetricsList, metricsv1beta1.PodMetrics, metricsv1beta1.PodMetricsList](
			"pods",
			c.RESTClient(),
